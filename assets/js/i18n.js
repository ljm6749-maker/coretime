...
(function (global) {
  ...
  var STRINGS = {
    ko: {
      ...
      'mail.teamsCopied': '본문 복사됨 · Teams에 붙여넣기',
      'mail.teamsHint': "Teams '새 모임' 창이 위 제목 · 시각으로 채워진 채 열립니다. Teams가 본문의 줄바꿈을 지우기 때문에, 본문은 클립보드에 함께 담아 드립니다 — 세부 정보 칸에 붙여넣기(Ctrl+V) 해 주세요. 참석자도 창에서 직접 추가해 주세요.",
      'mail.copied': '복사 완료',
    ...
    en: {
      ...
      'mail.teamsCopied': 'Body copied · paste into Teams',
      'mail.teamsHint': "Opens the Teams 'New meeting' form prefilled with the subject and time above. Teams strips line breaks from the details field, so the body is copied to your clipboard as well — paste it in with Ctrl+V. Add attendees there too.",
      'mail.copied': 'Copied',
