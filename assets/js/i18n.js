...
(function (global) {
  ...
  var STRINGS = {
    ko: {
      ...
      'mail.teamsHint': "Teams '새 모임' 창이 위 제목 · 시각 · 본문으로 채워진 채 열립니다. 참석자는 창에서 직접 추가해 주세요.",
      'mail.copied': '복사 완료',
    ...
    en: {
      ...
      'mail.teamsHint': "Opens the Teams 'New meeting' form prefilled with the subject, time and body above. Add attendees there.",
      'mail.copied': 'Copied',
