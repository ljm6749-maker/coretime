...
(function (global) {
  ...
  var STRINGS = {
    ko: {
      ...
      'policy.sec2Desc': '시차가 안정적이거나 교대가 비효율적인 조합입니다. 연중 같은 시간대를 씁니다.',
      'policy.sec3': '3. 그 외 조합',
      'policy.sec3Desc': '위 규칙에 해당하지 않는 조합은 참여 법인의 근무시간을 기준으로 자동 편성합니다.',
      'policy.sec3a': '모두의 근무시간이 겹치면 그 안에서 최대 4시간까지 편성합니다.',
      'policy.sec3b': '겹치는 구간이 없으면 근무시간에 가장 가까운 2시간으로 편성합니다.',
      'policy.sec3c': '모든 법인이 현지 07:00–21:00 안에 드는 시각이 없으면 추천시간을 표시하지 않습니다.',
      'policy.colWho': '참여 법인',
      'policy.colWhen': '회의 추천시간',
      'policy.dst': '서머타임',
      'policy.source': '참고 — Global Collaboration Ground Rules 1.1 원문 기준표',
      'policy.current': '적용 중',
      'policy.koreaTime': '한국',
    ...
    en: {
      ...
      'policy.sec3Desc': 'Any other combination is derived automatically from the business hours of the entities involved.',
      'policy.sec3a': 'Where their business hours overlap, up to four hours inside that overlap.',
      'policy.sec3b': 'Where they do not overlap, the closest two-hour window instead.',
      'policy.sec3c': 'If no time keeps everyone within 07:00–21:00 locally, no window is shown.',
      'policy.colWho': 'Entities',
      'policy.colWhen': 'Recommended hours',
      'policy.dst': 'DST',
      'policy.source': 'Reference — original table from Global Collaboration Ground Rules 1.1',
