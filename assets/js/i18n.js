...
(function (global) {
  ...
  var STRINGS = {
    ko: {
      ...
      'policy.sec3a': '최대한 근무시간 또는 근무 인접시간에서 2–4시간으로 편성합니다.',
      'policy.sec3b': '겹치는 시간이 없는 경우, 별도의 회의추천시간은 편성되지 않으며 당사자 간 협의를 통해 정합니다.',
      'policy.colWho': '참여 법인',
    ...
    en: {
      ...
      'policy.sec3a': 'A two- to four-hour window inside — or as close as possible to — everyone\'s business hours.',
      'policy.sec3b': 'Where no such time exists, no window is suggested and the parties involved agree a time directly.',
