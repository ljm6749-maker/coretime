...
(function (global) {
  ...
  var STRINGS = {
    ko: {
      ...
      'policy.sec3c': '그 외 경우, 별도의 회의추천시간은 편성되지 않으며 당사자 간 협의를 통해 정해주세요.',
      'policy.colWho': '참여 법인',
    ...
    en: {
      ...
      'policy.sec3c': 'Otherwise no window is suggested — please agree a time directly between the parties involved.',
